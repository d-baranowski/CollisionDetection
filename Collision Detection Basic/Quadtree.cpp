...
void Quadtree::split()
{
	...
	nodes[0] = new Quadtree(level + 1, Rectangle(bounds.get_x_pos() + subWidth, bounds.get_y_pos(), subWidth, subHeight));
	nodes[1] = new Quadtree(level + 1, Rectangle(bounds.get_x_pos(), bounds.get_y_pos(), subWidth, subHeight));
	nodes[2] = new Quadtree(level + 1, Rectangle(bounds.get_x_pos(), bounds.get_y_pos() + subHeight, subWidth, subHeight));
	nodes[3] = new Quadtree(level + 1, Rectangle(bounds.get_x_pos() + subWidth, bounds.get_y_pos() + subHeight, subWidth, subHeight));
}
